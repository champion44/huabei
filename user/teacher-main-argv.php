	...
	<script >
		...
		$(document).ready(function(){
			...
			$('.selectItem').on('click',function(){
				...
				var glob = "<?php	
				include '../database/config.php';
				$back=$_GET['trans_data'];
				$sql_count = "SELECT * FROM studentlist where labName = '{$experimentname}' and labTime ='2号上午08:00-10:00'";
